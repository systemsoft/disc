...
Deno.test("Server Integration - Basic Server Startup", async () => {
...
Deno.test("Server Integration - Health Check Endpoint", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Stats Endpoint", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - CORS Headers", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Valid EdgeQL Select Query", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Valid EdgeQL Insert Query", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - EdgeQL Query with Variables", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Invalid EdgeQL Syntax", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
  ...
  assertStringIncludes(result.errors[0].message.toLowerCase(), "error");

  await harness.stop();
});

Deno.test("Server Integration - Empty Query Validation", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Large Query Rejection", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Invalid JSON Request", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Wrong HTTP Method", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Unknown Endpoint", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Request Timeout Handling", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Session Management", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Client Info Parsing", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Explain Mode", async () => {
  const harness = new ServerTestHarness();
  await harness.start();
...
Deno.test("Server Integration - Dry Run Mode", async () => {
  const harness = new ServerTestHarness();
  await harness.start();

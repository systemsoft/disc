...
/**
 * Rust emitter on the codegen IR (RFC 0001, Phase 4).
 *
...
class RustEmitter {
  ...
  private libRs(): string {
    let out = "";
    out += "//! Generated Disc client (Rust) — RFC 0001 Phase 4 emitter.\n";
...
//! Generated by the Disc Rust codegen (RFC 0001 Phase 4) — DO NOT EDIT.

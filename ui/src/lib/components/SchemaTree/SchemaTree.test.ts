        ...
        types: [
          {
            ...
            properties: [
              ...
              { name: 'email', type: 'str', required: true, constraint: 'exclusive' },
              { name: 'name', type: 'str', required: true },
              { name: 'created_at', type: 'datetime', default: 'datetime_current()' }
            ],
            links: [
          ...
          },
          {
            ...
            links: [
              { name: 'author', target: 'User', cardinality: 'one', required: true }
            ]
          }
        ]
      }

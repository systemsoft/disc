...
export class CLICommands {
  ...
  private async createMigration(engine: MigrationEngine, config: Types.MigrationConfig): Promise<void> {
  ...
  private async applyMigrations(engine: MigrationEngine, config: Types.MigrationConfig): Promise<void> {
